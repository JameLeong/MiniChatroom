...
<body>
	...
	<div id="regDiglog" class="modal hide fade">
			...
			<form id="regform" class="form-horizontal" method="post" action="./talkService.srv?action=reg">
				<div class="control-group">
					...
					<div class="controls">
						...
						<span name="hasUser" class="help-inline hide">已存在该账户</span>
					</div>
				</div>
				<div class="control-group">
		...
		<div class="modal-footer">
			...
			<a id="loginBtn" class="btn btn-success" href="./talkService.srv?action=loginPage">返回登录</a>
		</div>
	</div>
...
<script type="text/javascript">
	$(function(){
		$("#regDiglog").modal({backdrop:"static",keyboard: false});
		...
		$("#regBtn").click(function(){
			...
			$.ajax({
                type: "POST",
                url: './talkService.srv?action=isUser',
                ...
                success: function(data) {
                	...
                	if(result  == "no"){
                		...
                		$("#userName").parents(".control-group").addClass("error");
						$("#userName").siblings(".help-inline[name='hasUser']").show();
						$("#userName").one("focus",function(){
							$(this).parents(".control-group").removeClass("error");
							$(this).siblings(".help-inline[name='hasUser']").hide();
						});
                	}
                	return;
                }
